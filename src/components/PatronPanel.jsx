  ...
  return (
    <div className="flex flex-col items-center gap-3 text-center">
      ...
      <div className="flex flex-col gap-0.5">
        <p className="text-[#191919] text-[15px] md:text-[17px] font-bold leading-snug">{name}</p>
        <p className="text-[#64748b] text-[13px] md:text-[15px] font-medium leading-snug">{role}</p>
      </div>
    </div>
  )
}

export default function PatronPanel({ title, icon, gridClassName, people }) {
  return (
