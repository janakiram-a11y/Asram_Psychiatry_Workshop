...
export default function Hero() {
  return (
    <section className="relative min-h-[420px] md:h-[608px] flex items-center overflow-hidden bg-[#17365d]">
      <div className="absolute inset-0" style={{ opacity: 0.82 }}>
        <img
          alt=""
      ...
      />
      <div className="relative z-10 w-full px-4 md:px-[100px] py-14 md:py-0">
        <div className="w-full max-w-[1240px] mx-auto flex flex-col gap-4 md:gap-6">
          <div className="flex items-center gap-2 self-start bg-white/[0.14] border border-white/[0.22] rounded-full px-[15px] py-[7px]">
